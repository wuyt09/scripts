...
!
  ...
  public heatforc   ! the heatforcing field that will be used in the model
  ...
  !***MOD START****
  real(r8), allocatable:: heatforc(:,:,:,:)  ! Heating Flags
  !***MOD END******
...
!-----------------------------------------------------------------------
    ...
    if(.not. (adiabatic .or. ideal_phys)) then
       ...
       !***MOD START*****
       allocate (heatforc (pcols,pver,begchunk:endchunk,12))  ! 12 -- timeframe
       !***MOD END*******
