      ...
      INTEGER,PARAMETER :: zd1=37,IX=144,IY=96,zd18=38
...
c             irec=(j-2)*ix+i-1 !drdt_ran has infinite values this location
             irec = irec - 1
             read(21,rec=irec)drdt
             print*,irec
c             PAUSE
