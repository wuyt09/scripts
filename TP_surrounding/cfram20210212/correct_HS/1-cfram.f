...
c  input data
      ...
      real strflx_warm(ix,iy),ssrflx_warm(ix,iy)
...
!partial temp. output
 ...
 100   continue
       ...
       read(31,rec=nnn)lhflx_base
       read(32,rec=nnn)lhflx_warm
       read(33,rec=nnn)shflx_base
       read(34,rec=nnn)shflx_warm
       read(35,rec=nnn)ssrflx_base
       read(36,rec=nnn)ssrflx_warm
       read(37,rec=nnn)strflx_base
       read(38,rec=nnn)strflx_warm
