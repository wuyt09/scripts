...
c          print*, "after cloud"
     ...
     &                        -(lhflx_warm(i,j)-lhflx_base(i,j))      
          ...
          enddo
           ...
           dt_SR(i,j,zd18)=dt_SR(i,j,nv1)
           fc_SR(i,j,zd18)=fc_SR(i,j,nv1)
           IF(nv.LT.zd1) then
             do l=nv1,zd1
                dt_albedo(i,j,l)=-999
                dt_wv(i,j,l)=-999
...
c       enddo
       ...
       call out3d(dt_SR,ix,iy,zd18,51,irec)
       call out3d(fc_SR,ix,iy,zd18,52,irec)
