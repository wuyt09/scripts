...
***********************data input*************************************
     ...
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 14, file = '../data/raw/t2m_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 15, file = '../data/raw/huss_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 16, file = '../data/raw/sp_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 17, file = '../data/raw/o3_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
     ...
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 111, file = '../data/raw/hus_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 112, file = '../data/raw/t_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
...
*     OUTPUT
*
       open ( unit = 22, file = './warm_radranc_1.grd',
     & form='unformatted', access='direct',recl= ix*iy )
       open ( unit = 32, file = './warm_radsfc_ranc_1.grd',
     & form='unformatted', access = 'direct',recl = ix*iy )

       open ( unit = 51, file = './warm_input_1.dat',
     & form='unformatted', access = 'direct', recl = ix*iy )
