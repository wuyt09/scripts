...
***********************data input*************************************
     ...
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 18, file = '../data/raw/cc_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 19, file = '../data/raw/clwc_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 110, file = '../data/raw/ciwc_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
...
*     OUTPUT
*
       open ( unit = 22, file = './cloud_radranc_1.grd',
     & form='unformatted', access='direct',recl= ix*iy )
       open ( unit = 32, file = './cloud_radsfc_ranc_1.grd',
     & form='unformatted', access = 'direct',recl = ix*iy )

       open ( unit = 51, file = './cloud_input_1.dat',
     & form='unformatted', access = 'direct', recl = ix*iy )
       open ( unit = 52, file = './warm_no_cloud_out_1.dat',
