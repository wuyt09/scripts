...
*     OUTPUT
*
       open ( unit = 22, file = './baseline_radranc_1.grd',
     & form='unformatted', access='direct',recl= ix*iy )
       open ( unit = 32, file = './baseline_radsfc_ranc_1.grd',
     & form='unformatted', access = 'direct',recl = ix*iy )

       open ( unit = 51, file = './baseline_input_1.dat',
     & form='unformatted', access = 'direct', recl = ix*iy )
...
c      enddo
       ...
       do i = 1, ix
          ...
          enddo
       enddo
       open ( unit = 998, file = './albedo_base.dat',
     & form='unformatted', access = 'direct', recl = ix*iy )
       write(998,rec=1)albedo
