     ...
     &       925.,950.,1000./)
***********************data input*************************************
      open ( unit = 11, file = '../data/raw/solarin_warm.dat',
...
*     OUTPUT
*
       open ( unit = 22, file = './solar_radranc_1.grd',
     & form='unformatted', access='direct',recl= ix*iy )
       open ( unit = 32, file = './solar_radsfc_ranc_1.grd',
     & form='unformatted', access = 'direct',recl = ix*iy )

       open ( unit = 51, file = './solar_input_1.dat',
     & form='unformatted', access = 'direct', recl = ix*iy )
