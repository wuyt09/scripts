...
***********************data input*************************************
     ...
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 12, file = '../data/raw/ssrd_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
      open ( unit = 13, file = '../data/raw/ssru_warm.dat',
     & form='unformatted', access='direct',recl = xt*yt )
...
*     OUTPUT
*
       open ( unit = 22, file = './albedo_radranc_1.grd',
     & form='unformatted', access='direct',recl= ix*iy )
       open ( unit = 32, file = './albedo_radsfc_ranc_1.grd',
     & form='unformatted', access = 'direct',recl = ix*iy )

       open ( unit = 51, file = './albedo_input_1.dat',
     & form='unformatted', access = 'direct', recl = ix*iy )
...
c      enddo
       ...
       do i = 1, ix
          ...
          enddo
       enddo
       open ( unit = 998, file = './albedo_warm.dat',
     & form='unformatted', access = 'direct', recl = ix*iy )
