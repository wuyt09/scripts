      ...
      INTEGER,PARAMETER :: zd1=17,IX=144,IY=96,zd18=18
...
!partial temp. output
 ...
 100   continue
       ...
       print*,"base",rht_base(28,65,zd18)
       print*,"warm",rht_warm(28,65,zd18)
       print*,"albedo",rht_albedo(28,65,zd18)
       print*,"cloud",rht_cloud(28,65,zd18)
       print*,"wv",rht_wv(28,65,zd18)
       print*,"o3",rht_o3(28,65,zd18)
       print*,"solar",rht_solar(28,65,zd18)
       print*,"co2",rht_co2(28,65,zd18)
c       pause 
...
c          print*,rht_base(i,j,:)
          ...
          if(isnan(drdt(1,1)))then
             ...
             irec=288 !drdt_ran has infinite values this location
             read(21,rec=irec)drdt
c              goto 2000 
c             PAUSE
          endif
...
c          print*,irec
          ...
          enddo
          print*,"fc_albedo",fc_albedo(28,65,zd18)
          call delt_gauss(drdt,fc,nv1)
          do k = 1, nv1
             dt_albedo(i,j,k)=fc(k)
          enddo
          print*,"dt_albedo",dt_albedo(28,65,zd18)
          pause
