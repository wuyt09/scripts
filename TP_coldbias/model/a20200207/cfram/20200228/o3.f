      ...
      integer,parameter:: xt=144,yt=96,z1=17,z18=18
      real             :: plev(1:z1)
      ...
      plev = (/10.,20.,30.,50.,70.,100.,150.,200.,250.,300.,400.,500.,
...
c       do 2000 ilat = 28, 28
c          do 2000 ilong = 65, 65 
c          print*,ilat,ilong
...
c          print*,ilong,ilat,level_lowest,zd1
          endif
...
c             pmean=0.5*(pp(l)+pp(l+1))
 ...
 ! cloudy sky calculation
     ...
     &            lw_base,water_c,ice_c,iseed,no_cloud_out)
      ...
      if (ILONG.eq.27 .and. ILAT.eq.65) then
          print*,"rad_base",rad_base(nv1),"nv1",nv1
      end if
      if (ILONG.eq.28 .and. ILAT.eq.65) then
          print*,"rad_base",rad_base(nv1),"nv1",nv1
      end if
          DO l=1,nv
c             print*,fuir_tot(l),fdir_tot(l),l
 ...
 2000  continue
       print*,"rad_conv",rad_conv(28,65,zd18)
       print*,"rad_conv",rad_conv(27,65,zd18)
       pause
